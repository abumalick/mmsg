...
export default class Homepage extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <Page { ...this.props } header={
          <div>
            <div
              className={styles.hero}
              style={this.props.head.hero && {
                background: `#fff url(${this.props.head.hero}) 0% 50% / cover`,
              }}
            />
        ...
        } body=''>
          {
            <div className={styles.hero2}>
              <Grid textAlign="center">
                <Grid.Column key="img" className={`${styles.hero2Img} hide-mobile`} tablet={8} computer={8}>
                  <Image src={this.props.head.hero2} alt="Photo de La Maison Médicale de Saint-Guidon" fluid />
                </Grid.Column>
                <Grid.Column key="body" mobile={16} tablet={8} computer={8}>
                  <div className={styles.hero2Body}>
                    ...
                    <p contentEditable='true' dangerouslySetInnerHTML={{ __html: this.props.body }} />
                  </div>
                </Grid.Column>
              </Grid>
            </div>
